...
test("Create DELETE bookingAPI request in Playwright", async ({ request }) => {
...
// 8) Send the DELETE request to delete the booking
...
console.log("DELETE API Response Status:", await expect(deleteAPIResponse.status()).toBe(201));
